...
--
-- Impulse event for Flexible stat to track power weapon pickups
--

onObjectTaken:Target(TargetPlayer):Response(
	{
		ImpulseEvent = 'impulse_power_weapon_grabbed'
	});

onPlayerPickedUpBlastedObject:Target(TargetPlayer):Response(
	{
		ImpulseEvent = 'impulse_power_weapon_grabbed'		
	});

onPlayerPickedUpAmmoFromBlastedObject:Target(TargetPlayer):Response(
	{
		ImpulseEvent = 'impulse_power_weapon_grabbed'		
	});